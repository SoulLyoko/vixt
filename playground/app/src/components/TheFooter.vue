...
<template>
  <view flex="~ gap-4" justify-center mt-6 text-xl>
    <navigator icon-btn url="/pages/index" title="Home">
      <Icon icon="carbon:campsite" width="20px" />
    </navigator>

    <view icon-btn title="ToggleDark" @click="toggleDark()">
